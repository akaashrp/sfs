...
SIMULATION_BATCH_TIME_FEATURE_SET="cross_term"
...
CALIBRATION_JOB_ID="$(
  sbatch --parsable \
    ...
    --export="ALL,RUN_MODE=calibrate,EXPERIMENT_TAG=$EXPERIMENT_TAG,RUN_ROOT=$RUN_ROOT,CALIBRATION_OUTPUT_PATH=$CALIBRATION_OUTPUT_PATH,SFS_ROOT=$SFS_ROOT,SIMULATION_BATCH_TIME_FEATURE_SET=$SIMULATION_BATCH_TIME_FEATURE_SET" \
    "$SBATCH_SCRIPT"
)"
...
SWEEP_JOB_ID="$(
  sbatch --parsable \
    ...
    --export="ALL,RUN_MODE=sweep,EXPERIMENT_TAG=$EXPERIMENT_TAG,RUN_ROOT=$RUN_ROOT,CALIBRATION_OUTPUT_PATH=$CALIBRATION_OUTPUT_PATH,SFS_ROOT=$SFS_ROOT,SIMULATION_BATCH_TIME_FEATURE_SET=$SIMULATION_BATCH_TIME_FEATURE_SET" \
    "$SBATCH_SCRIPT"
)"
